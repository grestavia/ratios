...
export default function DonationModal({ isOpen, onOpenChange, handleSubmit, handleInputChange, isInvalidInput, inputValue, formatNumber }: any) {
  return (
    <Modal className="rounded-lg" isOpen={isOpen} onOpenChange={onOpenChange}>
      <ModalContent>
        {(onClose) => (
